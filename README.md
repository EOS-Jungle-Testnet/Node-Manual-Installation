...
```
mkdir /opt/bin
mkdir /opt/bin/v2.0.1
cp /opt/EOSIO/eos/build/programs/nodeos/nodeos /opt/bin/v2.0.1/
cp /opt/EOSIO/eos/build/programs/cleos/cleos /opt/bin/v2.0.1/
cp /opt/EOSIO/eos/build/programs/keosd/keosd /opt/bin/v2.0.1/
ln -sf /opt/bin/v2.0.1 /opt/bin/bin
```
...
https://github.com/EOSIO/eos/releases/tag/v2.0.1   
For example, for ubuntu 18.04 you need to download deb eosio_2.0.1-ubuntu-18.04_amd64.deb              
To install it you can use apt:  
```
apt install ./eosio_2.0.1-ubuntu-18.04_amd64.deb   
```
...
```
 mkdir /opt/bin
 mkdir /opt/bin/v2.0.1
 cp /usr/opt/eosio/v2.0.1/bin/nodeos /opt/bin/v2.0.1/
 cp /usr/opt/eosio/v2.0.1/bin/cleos /opt/bin/v2.0.1/
 cp /usr/opt/eosio/v2.0.1/bin/keosd /opt/bin/v2.0.1/
 ln -sf /usr/opt/eosio/v2.0.1/bin /opt/bin/bin
```
