...
```
mkdir /opt/bin
mkdir /opt/bin/v1.5.0
cp /opt/EOSIO/eos/build/programs/nodeos/nodeos /opt/bin/v1.5.0/
cp /opt/EOSIO/eos/build/programs/cleos/cleos /opt/bin/v1.5.0/
cp /opt/EOSIO/eos/build/programs/keosd/keosd /opt/bin/v1.5.0/
ln -sf /opt/bin/v1.5.0 /opt/bin/bin
```
...
https://github.com/EOSIO/eos/releases/tag/v1.5.0   
...
```
 mkdir /opt/bin
 mkdir /opt/bin/v1.5.0
 cp /usr/opt/eosio/1.5.0/bin/nodeos /opt/bin/v1.5.0/
 cp /usr/opt/eosio/1.5.0/bin/cleos /opt/bin/v1.5.0/
 cp /usr/opt/eosio/1.5.0/bin/keosd /opt/bin/v1.5.0/
 ln -sf /usr/opt/eosio/1.5.0/bin /opt/bin/bin
```
