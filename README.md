...
```
 mkdir /opt/bin
 mkdir /opt/bin/v1.7.3
 cp /usr/opt/eosio/v1.7.3/bin/nodeos /opt/bin/v1.7.3/
 cp /usr/opt/eosio/v1.7.3/bin/cleos /opt/bin/v1.7.3/
 cp /usr/opt/eosio/v1.7.3/bin/keosd /opt/bin/v1.7.3/
 ln -sf /usr/opt/eosio/v1.7.3/bin /opt/bin/bin
```
