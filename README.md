...
```
 mkdir /opt/bin
 mkdir /opt/bin/v1.4.4
 cp /usr/opt/eosio/1.4.4/bin/nodeos /opt/bin/v1.4.4/
 cp /usr/opt/eosio/1.4.4/bin/cleos /opt/bin/v1.4.4/
 cp /usr/opt/eosio/1.4.4/bin/keosd /opt/bin/v1.4.4/
 ln -sf /usr/opt/eosio/1.4.4/bin /opt/bin/bin
```
...
Remember the password,it will be used when unlock wallet  
- Unlock your wallet  
```
