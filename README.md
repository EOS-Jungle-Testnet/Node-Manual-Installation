...
```
 mkdir /opt/bin
 mkdir /opt/bin/v2.0.4
 cp /usr/opt/eosio/v2.0.4/bin/nodeos /opt/bin/v2.0.4/
 cp /usr/opt/eosio/v2.0.4/bin/cleos /opt/bin/v2.0.4/
 cp /usr/opt/eosio/v2.0.4/bin/keosd /opt/bin/v2.0.4/
 ln -sf /usr/opt/eosio/v2.0.4/bin /opt/bin/bin
```
