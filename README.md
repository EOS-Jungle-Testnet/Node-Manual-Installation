...
```
apt install ./eosio_2.0.4-7-ubuntu-18.04_amd64.deb   
```
...
```
 mkdir /opt/bin
 mkdir /opt/bin/v2.0.7
 cp /usr/opt/eosio/2.0.7/bin/nodeos /opt/bin/v2.0.7/
 cp /usr/opt/eosio/2.0.7/bin/cleos /opt/bin/v2.0.7/
 cp /usr/opt/eosio/2.0.7/bin/keosd /opt/bin/v2.0.7/
 ln -sf /opt/bin/v2.0.7 /opt/bin/bin
```
