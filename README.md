...
cp /opt/EOSIO/eos/build/programs/cleos/cleos /opt/bin/v1.7.2/
cp /opt/EOSIO/eos/build/programs/keosd/keosd /opt/bin/v1.7.2/
ln -sf /opt/bin/v1.7.2 /opt/bin/bin
```
...
https://github.com/EOSIO/eos/releases/tag/v1.7.2   
...
```
It will download all dependencies and install EOSIO to /usr/opt/eosio/v1.7.2 
B. Copy binaries to keep old versions and make sym link to latest:  

```
 mkdir /opt/bin
 mkdir /opt/bin/v1.7.2
 cp /usr/opt/eosio/v1.7.2/bin/nodeos /opt/bin/v1.7.2/
 cp /usr/opt/eosio/v1.7.2/bin/cleos /opt/bin/v1.7.2/
 cp /usr/opt/eosio/v1.7.2/bin/keosd /opt/bin/v1.7.2/
 ln -sf /usr/opt/eosio/v1.7.2/bin /opt/bin/bin
```
