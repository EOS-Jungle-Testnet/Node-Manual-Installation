...
```
mkdir /opt/bin
mkdir /opt/bin/v1.6.0
cp /opt/EOSIO/eos/build/programs/nodeos/nodeos /opt/bin/v1.6.0/
cp /opt/EOSIO/eos/build/programs/cleos/cleos /opt/bin/v1.6.0/
cp /opt/EOSIO/eos/build/programs/keosd/keosd /opt/bin/v1.6.0/
ln -sf /opt/bin/v1.6.0 /opt/bin/bin
```
...
```
It will download all dependencies and install EOSIO to /usr/opt/eosio/1.6.0 
B. Copy binaries to keep old versions and make sym link to latest:  

```
 mkdir /opt/bin
 mkdir /opt/bin/v1.6.0
 cp /usr/opt/eosio/1.6.0/bin/nodeos /opt/bin/v1.6.0/
 cp /usr/opt/eosio/1.6.0/bin/cleos /opt/bin/v1.6.0/
 cp /usr/opt/eosio/1.6.0/bin/keosd /opt/bin/v1.6.0/
 ln -sf /usr/opt/eosio/1.6.0/bin /opt/bin/bin
```
