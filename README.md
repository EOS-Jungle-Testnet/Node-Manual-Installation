...
```
mkdir /opt/bin
mkdir /opt/bin/v1.5.1
cp /opt/EOSIO/eos/build/programs/nodeos/nodeos /opt/bin/v1.5.1/
cp /opt/EOSIO/eos/build/programs/cleos/cleos /opt/bin/v1.5.1/
cp /opt/EOSIO/eos/build/programs/keosd/keosd /opt/bin/v1.5.1/
ln -sf /opt/bin/v1.5.1 /opt/bin/bin
```
...
```
 mkdir /opt/bin
 mkdir /opt/bin/v1.5.1
 cp /usr/opt/eosio/1.5.0/bin/nodeos /opt/bin/v1.5.1/
 cp /usr/opt/eosio/1.5.0/bin/cleos /opt/bin/v1.5.1/
 cp /usr/opt/eosio/1.5.0/bin/keosd /opt/bin/v1.5.1/
...
cp /opt/EOSIO/eos/build/programs/cleos/cleos /opt/bin/v1.5.1/
cp /opt/EOSIO/eos/build/programs/keosd/keosd /opt/bin/v1.5.1/
ln -sf /opt/bin/v1.5.1-rc1 /opt/bin/bin
```  
